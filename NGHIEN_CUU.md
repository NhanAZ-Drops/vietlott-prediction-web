...
- so sánh với baseline đồng đều trên cùng kỳ đích bằng phép so sánh cặp
- báo cáo số lượt kỳ vọng, khoảng dự đoán 95% và điểm kỳ vọng dưới baseline
- không gộp tỷ lệ đúng giữa các sản phẩm có không gian kết quả khác nhau
